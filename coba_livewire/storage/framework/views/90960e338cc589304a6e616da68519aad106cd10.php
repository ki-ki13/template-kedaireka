    ...
    <thead>
      <tr class="text-center">
        ...
        <th  scope="col" >
          <span>
            No FPPP
            <i wire:click="sortBy('fppps->fppp_no')" style="cursor: pointer" class="material-icons-round <?php echo e($sortBy === 'fppp_no' && $sortDirection === 'desc' ? '' : 'no-use'); ?>">arrow_drop_down</i>
          </span> 
        </th>
        <th  scope="col" >
          <span>
        ...
        <th  scope="col">
            <span>
              Kota
              <i wire:click="sortBy('tujuan')" style="cursor: pointer" class="material-icons-round <?php echo e($sortBy === 'tujuan' && $sortDirection === 'desc' ? '' : 'no-use'); ?>">arrow_drop_down</i>
            </span>
        </th>
    ...
    <tbody>
      <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr class="items-align-center">
                ...
                <td><?php echo e($item -> fppps -> quotation_no); ?></td>
                <td><?php echo e($item -> fppps -> fppp_no); ?></td>
                <td><?php echo e($item -> fppps -> applicator_name); ?></td>
                <td><?php echo e($item -> fppps -> project_name); ?></td>
                <td><?php echo e($item -> tujuan); ?></td>
                <td class="p-4 text-center">
                  <span class="status  p-2 rounded" style="background-color: <?php echo e($item -> status_color); ?>; color:<?php echo e($item-> status_text_color); ?>"><?php echo e($item -> acc_pengiriman); ?></span>
                </td>
                <td>
...
<?php echo $__env->make('layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Kedaireka\Coba\coba_livewire\resources\views/livewire/table-pengiriman.blade.php ENDPATH**/ ?>