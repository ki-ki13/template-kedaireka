<div id="sidebar-open bg-light" class="s"> 
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-light sidebar-item">
        ...
        <ul class="nav flex-column my-3">
          <li class="nav-item">
            <a href="/" class="d-flex nav-link p-3 align-items-center <?php echo e(Route::is('dashboard') ? 'active' : ''); ?>" aria-current="page">
...
</div><?php /**PATH D:\application\template\template-kedaireka\coba_livewire\resources\views/components/sidebar.blade.php ENDPATH**/ ?>